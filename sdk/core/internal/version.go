...
// Example:
//
//	-ldflags="-X 'github.com/wbreza/azd-extensions/sdk/core/internal.Version=0.0.1-alpha.1 (commit 8a49ae5ae9ab13beeade35f91ad4b4611c2f5574)'"
//
...
func VersionInfo() AzdVersionInfo {
	...
	if len(matches) != 3 {
		panic("azd version is malformed, ensure github.com/wbreza/azd-extensions/sdk/core/internal.Version is correct")
	}
